/*
  ...
  - The values [semi-hydroponics] on the enum `GrowingMedium` will be removed. If these variants are still used in the database, this will fail.
  - The values [morning-sun-light,afternoon-sun-light,full-day-sun-light,low-sun-light,indirect-sun-light,artificial-light] on the enum `LightExposure` will be removed. If these variants are still used in the database, this will fail.
  - The values [north-facing-northern-hemisphere,south-facing-northern-hemisphere,east-facing-northern-hemisphere,west-facing-northern-hemisphere,north-facing-southern-hemisphere,south-facing-southern-hemisphere,east-facing-southern-hemisphere,west-facing-southern-hemisphere,no-window] on the enum `WindowDirection` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GrowingMedium_new" AS ENUM ('soil', 'semi_hydroponics', 'hydroponics');
...
-- AlterEnum
BEGIN;
CREATE TYPE "LightExposure_new" AS ENUM ('morning_sun_light', 'afternoon_sun_light', 'full_day_sun_light', 'low_sun_light', 'indirect_sun_light', 'artificial_light');
